...
-- toggle hiddle files
vim.keymap.set("n", "<leader>h", ":lua require('oil').toggle_hidden()<CR>", { noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>vpp", "<cmd>e ~/.dotfiles/nvim/.config/nvim/lua/rondeben/packer.lua<CR>")
...
-- see bacon diagnostics in telescope
